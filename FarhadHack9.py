...
\033[1;31m│\033[1;37m☞  \033[1;32mGROUP\033[1;31m :    ➟ \033[1;32m AFGHAN HACK\033[1;37m {\033[1;36mFB\033[1;37m} \033[1;31m
...
def pass4():
    ...
    print('\x1b[38;5;46m[∆] CLONING COMPLETED\n[√] YOUR OK IDS : '+str(len(ok))+'\n\x1b[38;5;196m[×] YOUR CP IDS : '+str(len(cp)))
    print(f'\n[~]{WHITE}===================================================')
    print('\x1b[38;5;46m[√] OK IDS SAVE : /sdcard/Farhad-OK.txt\n\x1b[38;5;196m[×] CP IDS SAVE : /sdcard/ Farhad-CP.txt')
    input(f'{WHITE}[>] PRESS ENTER TO BACK MENU   ');os.system("clear");main()
